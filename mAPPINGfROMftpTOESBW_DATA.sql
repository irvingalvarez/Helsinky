...
LEFT JOIN (SELECT DISTINCT PersonnelNumber, CompanyCode, PersonnelSubArea, PersonnelArea  FROM dbo.lt_ftp_Employee_Data) PA0001 ON PA0001.PersonnelNumber = tt.PersonelID --DUPLICATED PERSONNEL NUMBER
